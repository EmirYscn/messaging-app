...
function AppLayout() {
  ...
  return (
    ...
    <div className="h-screen overflow-hidden flex justify-center lg:p-8">
      ...
      <div className="w-full lg:max-w-99/100 lg:rounded-2xl overflow-hidden grid grid-rows-[1fr_auto] lg:grid-rows-none lg:grid lg:grid-cols-[auto_auto_1fr] relative bg-[var(--color-grey-50)] text-[var(--color-grey-700)] shadow-lg">
